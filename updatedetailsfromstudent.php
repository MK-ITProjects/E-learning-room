...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<h3> Welcome <a href="welcomestudent"><?php echo "<span style='color:red'>"." ".$username."</span>";?></a></h3>
			<?php
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					Surname : <input type="text" name="sname" class="form-control" value="<?php echo $row['SName']; ?>"><br>
				</div>
				<div class="form-group">
					Student Name : <input type="text" name="name" class="form-control" value="<?php echo $row['Name']; ?>"><br>
				</div>
				<div class="form-group">
			...
			if ( isset( $_POST[ 'update' ] ) ) {
				...
				$sql = "UPDATE `studenttable` SET sname='$tempsname', name='$tempname', FaName='$tempfaname', Gender='$tempgender', city='$tempcity', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid', Pass='$temppass'  WHERE Eno=$new3";
