...
<div class="container" style="max-width: 1200px;">
	<div class="row">
		...
		if ( isset( $_POST[ 'submit' ] ) ) {
			...
			$sql = "INSERT INTO `studenttable` (`sname`, `name`, `FaName`,`Gender`, `Addrs`,`city`, `DOB`,  `PhNo`,  `Pass`,`Eid`) VALUES ('$sname','$name','$faname','$gender','$addrs','$city','$dob','$phno','$pass','$email')";
				...
				<fieldset>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="text" class="form-control" name="sname" id="sname" maxlength="30">
