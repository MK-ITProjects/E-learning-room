...
<div class="container">
	...
	<div class="row">
		...
		if ( isset( $_POST[ 'addnews' ] ) ) {
			...
			$sql = "Insert into studenttable (sname, name, FaName, DOB, Addrs, Gender, city, PhNo , Eid, Pass) values ('$tempsname', '$tempname', '$tempfaname', '$tempdob', '$tempaddrs' , '$tempgender', '$tempcity' , $tempphno, '$tempeid' , '$temppass')";
		...
		<div class="col-md-4">
			...
			<form action="" method="POST" name="updateform">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="city" name="city" placeholder="Assign city" required>
				</div>
