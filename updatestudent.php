	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					First Name : <input type="text" name="sname" class="form-control" value="<?php echo $row['sname']; ?>">
				</div>
				<div class="form-group">
					Last Name : <input type="text" name="name" class="form-control" value="<?php echo $row['name']; ?>"><br>
				</div>
				<div class="form-group">
